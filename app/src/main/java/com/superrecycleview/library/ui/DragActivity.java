...
public class DragActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnItemDragListener listener = new OnItemDragListener() {
            ...
            public void onItemDragStart(RecyclerView.ViewHolder viewHolder, int pos) {
                ...
                ((CardView) viewHolder.itemView).setCardBackgroundColor(
                        ContextCompat.getColor(DragActivity.this, R.color.colorAccent));
            }
        ...
        View headerView = getLayoutInflater().inflate(R.layout.view_header_layout,
                (ViewGroup) mRecyclerView.getParent(), false);
        View footerView = getLayoutInflater().inflate(R.layout.view_footer_layout,
                (ViewGroup) mRecyclerView.getParent(), false);
    ...
    public void onItemClick(View view, int position) {
        Toast.makeText(this, mData.get(position - 1), Toast.LENGTH_SHORT).show();
    }
